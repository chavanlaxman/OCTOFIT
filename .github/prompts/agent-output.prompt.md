---
name: "Agent Output"
description: "Use when generating or rewriting a per-phase SDLC artifact under artifacts/<JIRA-KEY>/ for requirements, architecture, design review, implementation planning, implementation, review, verification, or PR output."
argument-hint: "Provide the Jira key, phase name, source content, and target artifact path."
agent: "agent"
---
